        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
          <div className="space-y-2 max-w-xl">
            ...
            <p className="text-xs text-gray-400 leading-relaxed font-light font-sans">
              Destaque seu anúncio acima de todas as outras profissionais da sua categoria (Gold) na sua cidade e bairro por 2 horas inteiras por apenas **R$ 39,90**.
            </p>
          </div>
