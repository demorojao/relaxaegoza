        ...
        {!isCollapsed && (
          <div className="relative z-10 flex flex-col lg:flex-row justify-between items-center gap-6 sm:gap-8 animate-fadeIn pt-2 sm:pt-0">
            ...
            <div className="space-y-4 sm:space-y-5 text-center lg:text-left max-w-2xl">
              ...
              {/* Badge de Categoria */}
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gold-primary/10 border border-gold-primary/30 text-gold-light text-[10px] sm:text-xs font-bold uppercase tracking-wider">
                <Sparkles className="w-3 h-3 text-gold-primary animate-pulse" />
                Experiência Premium & Seleção de Elite
              </div>

              {/* Título Principal */}
              <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light tracking-tight text-white leading-tight">
              ...
              <div className="pt-2 flex flex-wrap justify-center lg:justify-start items-center gap-3 sm:gap-6 border-t border-white/5">
                <div className="flex items-center gap-2">
                  <div className="p-1.5 sm:p-2 rounded-xl bg-gold-primary/10 text-gold-primary">
                    <Users className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                  </div>
                  <div className="text-left">
                    <span className="text-xs sm:text-base font-bold text-white block leading-none">+50K</span>
                    <span className="text-[9.5px] sm:text-[10.5px] text-gray-400 font-medium uppercase tracking-wider">Clientes Atendidos</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    <span className="text-xs sm:text-base font-bold text-white block leading-none">100%</span>
                    <span className="text-[9.5px] sm:text-[10.5px] text-gray-400 font-medium uppercase tracking-wider">Perfis Auditados</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    <span className="text-xs sm:text-base font-bold text-white block leading-none">4.9 ★</span>
                    <span className="text-[9.5px] sm:text-[10.5px] text-gray-400 font-medium uppercase tracking-wider">Satisfação VIP</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-80 bg-black/60 border border-gold-primary/30 rounded-2xl p-4 sm:p-5 shadow-xl flex flex-col items-center text-center space-y-3 sm:space-y-3.5 shrink-0 backdrop-blur-md">
              <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-gold-primary/10 border border-gold-primary/20 flex items-center justify-center text-gold-primary">
                <Sparkles className="w-4.5 h-4.5 sm:w-5 sm:h-5" />
              </div>

              <div>
                <h3 className="text-xs sm:text-sm font-bold text-white tracking-wide">Crie seu Perfil de Anúncio</h3>
                <p className="text-[11px] sm:text-xs text-gray-300 font-light mt-0.5 leading-relaxed">
                  Cadastre-se super rápido e atenda clientes de alto padrão no portal mais exclusivo.
                </p>
              </div>

              <Link href="/cadastro" className="w-full">
                <button className="w-full py-2.5 sm:py-3 px-4 rounded-xl bg-linear-to-r from-gold-primary to-gold-dark text-dark-bg font-bold text-[11px] sm:text-xs uppercase tracking-wider shadow-md hover:scale-[1.02] transition-all flex items-center justify-center gap-1.5 cursor-pointer">
                  <span>Anunciar Meu Perfil</span>
                  <ArrowRight className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                </button>
              </Link>

              <div className="text-[10.5px] sm:text-xs text-gray-400 font-light">
