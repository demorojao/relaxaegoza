  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 pt-4 pb-2 transition-all duration-300 animate-fadeIn">
      <div className="relative rounded-3xl bg-linear-to-b from-black/90 via-dark-card/70 to-dark-bg/90 border border-gold-primary/20 p-6 sm:p-8 shadow-[0_10px_40px_rgba(0,0,0,0.6)] overflow-hidden">
        ...
        {/* Botão de Minimizar / Expandir no canto superior */}
        <button
          onClick={() => setIsCollapsed(!isCollapsed)}
          className="absolute top-4 right-4 p-2 rounded-xl bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white transition-all text-xs flex items-center gap-1 cursor-pointer z-10 border border-white/5"
          title={isCollapsed ? "Expandir banner" : "Minimizar banner"}
        >
          {isCollapsed ? (
            <>
              <span className="hidden sm:inline text-[10px] font-semibold">Exibir Destaque</span>
        ...
        {!isCollapsed && (
          <div className="relative z-10 flex flex-col lg:flex-row justify-between items-center gap-8 animate-fadeIn">
            
            {/* Lado Esquerdo: Textos & Métricas */}
            <div className="space-y-5 text-center lg:text-left max-w-2xl">
              
              {/* Badge de Categoria */}
              <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-gold-primary/10 border border-gold-primary/30 text-gold-light text-[10px] sm:text-xs font-bold uppercase tracking-widest">
                <Sparkles className="w-3.5 h-3.5 text-gold-primary animate-pulse" />
                Experiência Premium & Seleção de Elite
              </div>

              {/* Título Principal */}
              <h1 className="text-2xl sm:text-4xl lg:text-4xl font-light tracking-tight text-white leading-tight">
              ...
              <div className="pt-2 flex flex-wrap justify-center lg:justify-start items-center gap-6 sm:gap-8 border-t border-white/5">
                <div className="flex items-center gap-2.5">
                  <div className="p-2 rounded-xl bg-gold-primary/10 text-gold-primary">
                    <Users className="w-4 h-4" />
                  </div>
                  <div className="text-left">
                    <span className="text-sm sm:text-base font-bold text-white block leading-none">+50K</span>
                    <span className="text-[10px] text-gray-400 font-light uppercase tracking-wider">Clientes Atendidos</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="text-left">
                    <span className="text-sm sm:text-base font-bold text-white block leading-none">100%</span>
                    <span className="text-[10px] text-gray-400 font-light uppercase tracking-wider">Perfis Auditados</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="text-left">
                    <span className="text-sm sm:text-base font-bold text-white block leading-none">4.9 ★</span>
                    <span className="text-[10px] text-gray-400 font-light uppercase tracking-wider">Satisfação VIP</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-80 bg-black/60 border border-gold-primary/30 rounded-2xl p-5 sm:p-6 shadow-xl flex flex-col items-center text-center space-y-4 shrink-0 backdrop-blur-md">
              ...
              <div>
                <h3 className="text-sm font-bold text-white tracking-wide">Crie seu Perfil de Anúncio</h3>
              ...
              <Link href="/cadastro" className="w-full">
                <button className="w-full py-3 px-4 rounded-xl bg-linear-to-r from-gold-primary to-gold-dark text-dark-bg font-bold text-xs uppercase tracking-wider shadow-md hover:scale-[1.02] transition-all flex items-center justify-center gap-1.5 cursor-pointer">
        ...
        {/* Versão Minimizada (Apenas barra elegante) */}
        {isCollapsed && (
          <div className="flex items-center justify-between gap-4 py-1 text-xs text-gray-300">
            <div className="flex items-center gap-2">
              <Sparkles className="w-4 h-4 text-gold-primary shrink-0" />
              <span className="font-semibold text-white">Relaxe e Goze</span>
              <span className="hidden sm:inline text-gray-500">• Portal de Acompanhantes de Luxo & Massagens de Elite</span>
            </div>
            <Link href="/cadastro">
              <span className="text-[11px] font-bold text-gold-primary hover:underline cursor-pointer">
                Anunciar Perfil →
              </span>
            </Link>
          </div>
