        ...
        {!isCollapsed && (
          <div className="relative z-10 flex flex-col lg:flex-row justify-between items-center gap-6 sm:gap-8 animate-fadeIn pt-2 sm:pt-0">
            ...
            <div className="space-y-4 sm:space-y-5 text-center lg:text-left max-w-2xl">
              ...
              {/* Badge de Categoria */}
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gold-primary/10 border border-gold-primary/30 text-gold-light text-[10px] sm:text-xs font-bold uppercase tracking-widest">
                <Sparkles className="w-3.5 h-3.5 text-gold-primary animate-pulse" />
                Experiência Premium & Seleção de Elite
              </div>

              {/* Título Principal */}
              <h1 className="text-xl sm:text-3xl lg:text-4xl font-light tracking-tight text-white leading-tight">
              ...
              <div className="pt-2 flex flex-wrap justify-center lg:justify-start items-center gap-4 sm:gap-8 border-t border-white/5">
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    ...
                    <span className="text-[9px] sm:text-[10px] text-gray-400 font-light uppercase tracking-wider">Clientes Atendidos</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    ...
                    <span className="text-[9px] sm:text-[10px] text-gray-400 font-light uppercase tracking-wider">Perfis Auditados</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    ...
                    <span className="text-[9px] sm:text-[10px] text-gray-400 font-light uppercase tracking-wider">Satisfação VIP</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-80 bg-black/60 border border-gold-primary/30 rounded-2xl p-4 sm:p-6 shadow-xl flex flex-col items-center text-center space-y-3 sm:space-y-4 shrink-0 backdrop-blur-md">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gold-primary/10 border border-gold-primary/20 flex items-center justify-center text-gold-primary">
                <Sparkles className="w-5 h-5 sm:w-6 sm:h-6" />
              </div>

              <div>
                <h3 className="text-xs sm:text-sm font-bold text-white tracking-wide">Crie seu Perfil de Anúncio</h3>
                <p className="text-[10px] sm:text-[11px] text-gray-400 font-light mt-0.5 sm:mt-1 leading-relaxed">
