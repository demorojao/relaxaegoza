        ...
        {!isCollapsed && (
          <div className="relative z-10 flex flex-col lg:flex-row justify-between items-center gap-6 sm:gap-8 animate-fadeIn pt-2 sm:pt-0">
            ...
            <div className="space-y-4 sm:space-y-5 text-center lg:text-left max-w-2xl">
              ...
              {/* Badge de Categoria */}
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-gold-primary/10 border border-gold-primary/30 text-gold-light text-xs sm:text-sm font-bold uppercase tracking-wider">
              ...
              <div className="pt-2 flex flex-wrap justify-center lg:justify-start items-center gap-4 sm:gap-8 border-t border-white/5">
                <div className="flex items-center gap-2.5">
                  <div className="p-2 sm:p-2.5 rounded-xl bg-gold-primary/10 text-gold-primary">
                    <Users className="w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <div className="text-left">
                    <span className="text-sm sm:text-lg font-extrabold text-white block leading-none">+50K</span>
                    <span className="text-[11px] sm:text-xs text-gray-300 font-semibold uppercase tracking-wider">Clientes Atendidos</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="text-left">
                    ...
                    <span className="text-[11px] sm:text-xs text-gray-300 font-semibold uppercase tracking-wider">Perfis Auditados</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="text-left">
                    ...
                    <span className="text-[11px] sm:text-xs text-gray-300 font-semibold uppercase tracking-wider">Satisfação VIP</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-80 bg-black/60 border border-gold-primary/30 rounded-2xl p-5 sm:p-6 shadow-xl flex flex-col items-center text-center space-y-3.5 sm:space-y-4 shrink-0 backdrop-blur-md">
              ...
              <Link href="/cadastro" className="w-full">
                <button className="w-full py-3 sm:py-3.5 px-4 rounded-xl bg-linear-to-r from-gold-primary to-gold-dark text-dark-bg font-extrabold text-xs sm:text-sm uppercase tracking-wider shadow-md hover:scale-[1.02] transition-all flex items-center justify-center gap-2 cursor-pointer">
