  ...
  return (
    <main className={`w-full bg-dark-bg flex flex-col relative overflow-hidden selection:bg-gold-primary selection:text-dark-bg ${viewMode === 'reels' ? "h-dvh" : "min-h-screen pb-24 md:pb-0"}`}>
      ...
      {viewMode === 'reels' ? (
        ...
        <>
          {/* Quick Filter Chips (1-tap Mobile & Desktop Filtering) */}
          <div className="max-w-7xl mx-auto px-4 sm:px-6 mb-4 overflow-x-auto no-scrollbar scroll-smooth">
            <div className="flex items-center gap-2 py-1 min-w-max">
              <span className="text-[10px] uppercase font-bold tracking-widest text-gray-500 mr-1 hidden sm:inline">
                Atalhos:
              </span>

              {/* Disponível Agora */}
              <button
                onClick={() => setAvailableFilter(prev => !prev)}
                className={cn(
                  "px-3.5 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 border cursor-pointer select-none active:scale-95",
                  availableFilter
                    ? "bg-emerald-500/20 text-emerald-400 border-emerald-500/40 shadow-[0_0_15px_rgba(16,185,129,0.2)]"
                    : "bg-black/40 border-white/10 text-gray-300 hover:border-emerald-500/30 hover:text-white"
                )}
              >
                <span className={cn("w-2 h-2 rounded-full", availableFilter ? "bg-emerald-400 animate-pulse" : "bg-emerald-500/50")} />
                Disponível Agora
              </button>
              ...
              <button
                ...
                className={cn(
                  ...
                  verifiedFilter
                    ? "bg-gold-primary/20 text-gold-light border-gold-primary/40 shadow-[0_0_15px_rgba(212,175,55,0.2)]"
                    : "bg-black/40 border-white/10 text-gray-300 hover:border-gold-primary/30 hover:text-white"
                )}
              >
              ...
              <button
                ...
                className={cn(
                  ...
                  spaceFilter
                    ...
                    : "bg-black/40 border-white/10 text-gray-300 hover:border-purple-500/30 hover:text-white"
                )}
              >
                🏨 Local Próprio
              </button>
              ...
              {/* Preço Sob Consulta */}
              <button
                onClick={() => setPriceFilter(prev => prev === '0' ? '' : '0')}
                className={cn(
                  "px-3.5 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border cursor-pointer select-none active:scale-95",
                  priceFilter === '0'
                    ? "bg-wine-primary/20 text-wine-light border-wine-primary/40 shadow-[0_0_15px_rgba(144,12,63,0.2)]"
                    : "bg-black/40 border-white/10 text-gray-300 hover:border-wine-primary/30 hover:text-white"
                )}
              >
                💬 Preço Sob Consulta
              </button>
